...
public:
	...
	void setAll(int CusID, string password, string FirstName, string LastName, string address, string city, string state, int zip)
	{
	...
	{
		setAll(CustomerID, password, FirstName, LastName, address, city, state, zip);
	}

	// Constructor that allows creating a customer with provided information
	customer(int CustomerID, string password, string FirstName, string LastName, string address, string city, string state, int zip)
	{
		setAll(CustomerID, password, FirstName, LastName, address, city, state, zip);
	}
